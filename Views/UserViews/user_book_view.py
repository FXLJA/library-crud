...
def view():
    ...
    return render_template("user/book/view.html", list_book=BookController.get_all(), list_category=CategoryController.get_all())
...
def insert():
    ...
    if BookController.get_by_id(book_id) is not None:
        ...
        return render_template('user/book/insert.html', message="book_id sudah pernah terdaftar!", list_category=CategoryController.get_all())
...
def update(id):
    ...
    if request.method == 'GET':
        return render_template("user/book/update.html", book=BookController.get_by_id(id), list_category=CategoryController.get_all())
